...
const AssignAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    const response = await axios.get(
      "http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/id?appointmentId=" + appointmentId
    );
  ...
  const retrieveAllDoctor = async () => {
    const response = await axios.get("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/doctor/all");
  ...
  const saveAppointment = () => {
    ...
    axios
      .post(
        "http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/admin/assign/doctor",
        formData
      )
      .then((result) => {
