...
const ViewMyAppointment = () => {
  ...
  const retrieveAllAppointments = async () => {
    const response = await axios.get(
      "http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/patient/id?patientId=" + patient.id
    );
  ...
  const cancelAppointment = (appointmentId) => {
    ...
    fetch("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/patient/update", {
      method: "POST",
      headers: {
