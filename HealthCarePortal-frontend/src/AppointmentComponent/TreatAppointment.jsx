...
const TreatAppointment = () => {
  ...
  const retrieveAppointment = async () => {
    const response = await axios.get("ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/id?appointmentId="+appointmentId);
  ...
  const saveAppointment = () => {
    ...
    axios
      .post("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/appointment/doctor/update", formData)
      .then((result) => {
