...
const UserRegister = () => {
  ...
  const retrieveAllGenders = async () => {
    const response = await axios.get("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/user/gender");
    return response.data;
  };

  const retrieveAllBloodGroups = async () => {
    const response = await axios.get(
      "http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/patient/bloodgroup/all"
    );
    return response.data;
  };
  ...
  const retrieveAllSpecialist = async () => {
    const response = await axios.get(
      "http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/doctor/specialist/all"
    );
    return response.data;
  };
  ...
  const saveUser = (event) => {
    ...
    fetch("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/user/register", {
      method: "POST",
      headers: {
  ...
  <select onChange={handleUserInput} className="form-control" name="sex" defaultValue="">
