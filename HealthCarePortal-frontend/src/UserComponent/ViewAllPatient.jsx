...
const ViewAllPatient = () => {
  ...
  const retrieveAllPatient = async () => {
    const response = await axios.get("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/patient/all");
    console.log(response.data);
    return response.data;
  };

  const deletePatient = (patientId) => {
    fetch("http://ec2-43-204-212-81.ap-south-1.compute.amazonaws.com:8080/api/user/delete/id?userId=" + patientId, {
      method: "GET",
      headers: {
